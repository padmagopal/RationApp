...
<br><br>
    ...
    <a class="brand" href="#"><i class="icon-group icon-large"></i>&nbsp;Ration management system</a>
     <p><b>S</b>tockadmin</p>
     </div>
    </div>
	...
	$query=mysql_query("select * from stock_user where username='$username' and password='$password'")or die(mysql_error());
